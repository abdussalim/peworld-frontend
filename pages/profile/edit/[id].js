...
const Edit = ({ data, token, isApiError, apiError }) => {
  ...
  const onSubmitPhotoProject = async () => {
    ...
    await editPhotoProject(data.id, token, formData, setErrors);
    createToast("Edit Photo Success", "success");
    setIsLoading(false);
  ...
  const setInputExperience = (e, index) => {
  ...
  const deleteInputExperience = (index) => {
  ...
  const deleteInputProject = (index, projectID) => {
                  ...
                  <div className="col-12 col-md-4">
                    ...
                    >
                      ...
                      >
                        {data.photo ? (
                          <Image
                            src={`https://drive.google.com/thumbnail?id=${data.photo}&sz=s1080`}
                        ...
                        {form.experiences.map((exp, index) => (
                          <div key={data.id + "exp" + index}>
                            <ExperienceForm
                              ...
                              deleteInputExperience={deleteInputExperience}
                              index={index}
                            />
                          </div>
                        ))}
